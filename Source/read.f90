...
NAMELIST /DUMP/ BINGEOM_DIR,CFL_FILE,CLIP_RESTART_FILES,COLUMN_DUMP_LIMIT,CTRL_COLUMN_LIMIT,DEVC_COLUMN_LIMIT,&
                ...
                RAMP_SPEC,RAMP_TMP,RAMP_UVW,RENDER_FILE,RESULTS_DIR,SIG_FIGS,SIG_FIGS_EXP,SMOKE3D,SMOKE3D_VERSION,&
                SMV_PARALLEL_WRITE,STATUS_FILES,SUPPRESS_DIAGNOSTICS,TEMP_MAX_SMV,TEMP_MIN_SMV,TURB_INIT_CLOCK,&
                VELOCITY_ERROR_FILE,WRITE_CVODE_SUBSTEPS,WRITE_XYZ
...
REAL(EB) :: ACTIVATION_OBSCURATION,ACTIVATION_TEMPERATURE,ALPHA_C,ALPHA_E,BETA_C,BETA_E,CALIBRATION_CONSTANT, &
            ...
            PROBE_DIAMETER,PARTICLE_VELOCITY_TAU
...
CHARACTER(LABEL_LENGTH) :: SMOKEVIEW_ID(SMOKEVIEW_OBJECTS_DIMENSION),QUANTITY='null',PART_ID='null',FLOW_RAMP='null', &
                 ...
                 SPRAY_PATTERN_SHAPE='GAUSSIAN',SPECIFIC_HEAT_RAMP,PARTICLE_VELOCITY_RAMP='null'
...
NAMELIST /PROP/ ACTIVATION_OBSCURATION,ACTIVATION_TEMPERATURE,ALPHA_C,ALPHA_E,BETA_C,BETA_E,CALIBRATION_CONSTANT,&
                ...
                PARTICLES_PER_SECOND,PARTICLE_VELOCITY,PARTICLE_VELOCITY_RAMP,PART_ID,PDPA_END,&
...
READ_PROP_LOOP: DO N=0,N_PROP
   ...
   ENDIF
   IF (PARTICLE_VELOCITY_RAMP /= 'null') THEN
       CALL GET_RAMP_INDEX(PARTICLE_VELOCITY_RAMP,'TIME',PY%PARTICLE_VELOCITY_RAMP_INDEX)
   ELSE 
       PY%PARTICLE_VELOCITY_RAMP_INDEX = 0
   ENDIF
   ...
   ENDIF
   IF (ABS(PARTICLE_VELOCITY_TAU) > TWENTY_EPSILON_EB) THEN
       PY%PARTICLE_VELOCITY_TAU = PARTICLE_VELOCITY_TAU/TIME_SHRINK_FACTOR
       IF (PARTICLE_VELOCITY_TAU > 0._EB) PY%PARTICLE_VELOCITY_RAMP_INDEX = TANH_RAMP
       IF (PARTICLE_VELOCITY_TAU < 0._EB) PY%PARTICLE_VELOCITY_RAMP_INDEX = TSQR_RAMP
   ENDIF
...
MESH_LOOP: DO NM=1,NMESHES
   ...
   N_RADF_MAX = MAX(N_RADF_MAX,N_RADF)
